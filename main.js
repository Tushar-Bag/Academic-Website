...
(function () {
  ...
  if (prefersReducedMotion || !("IntersectionObserver" in window)) {
    ...
    var observer = new IntersectionObserver(
      ...
      // threshold: 0 means "trigger the instant even one pixel is visible" —
      // important for tall sections (like a long publication list), where a
      // higher threshold like 0.08 would require scrolling much further
      // before anything appears, causing a visible pause/stall.
      // rootMargin grows the detection zone below the viewport, so the
      // animation starts a little before the section actually scrolls
      // into view, making it feel instant rather than delayed.
